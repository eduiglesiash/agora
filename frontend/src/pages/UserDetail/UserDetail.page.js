                ...
                <form>
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input id="surname" name="surname" type="text" value={stateForm.surname} />
                        </div>
                        <div>
                            <label htmlFor="phone">Teléfono</label>
                            <input id="phone" name="phone00" type="number" value={stateForm.phone} />
                        </div>
                        <div>
                            <label htmlFor="email">Dirección de email</label>
                            <input id="email" name="email" type="email" value={stateForm.email} />
                        </div>
                    </fieldset>
                </form>
